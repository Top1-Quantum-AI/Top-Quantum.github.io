...
jest.mock('../src/services/subscriptionService', () => ({
  getCurrentUser: jest.fn().mockReturnValue({
    ...
    subscription: { planId: 'free', status: 'active', startDate: '2024-01-01', expiresAt: null, autoRenew: false },
  ...
  PLANS: {
    free: {
      name: 'المجاني',
      price: 0,
      limits: { maxQubits: 5, maxSimulationsPerMonth: 100, maxAlgorithms: 3, maxAPIRequestsPerDay: 100, maxTokensPerDay: 10000 },
    },
    professional: {
      name: 'الاحترافي',
      price: 29,
      limits: { maxQubits: 20, maxSimulationsPerMonth: 10000, maxAlgorithms: 10, maxAPIRequestsPerDay: 1000, maxTokensPerDay: 100000 },
    },
    enterprise: {
      name: 'المؤسسات',
      price: 99,
      limits: { maxQubits: 128, maxSimulationsPerMonth: Infinity, maxAlgorithms: Infinity, maxAPIRequestsPerDay: 10000, maxTokensPerDay: 1000000 },
    },
  },
...
jest.mock('../src/services/quantumSimulator', () => ({
  ...
  algorithms: [
    { name: 'Grover', description: 'Search algorithm', qubits: 4, gates: [] },
  ],
}));

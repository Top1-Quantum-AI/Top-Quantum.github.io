    ...
    <div className="bg-gray-900/80 backdrop-blur-xl border-b border-gray-700/50 px-6 py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={(): void => { void navigate('/admin'); }}
            className="p-2 rounded-lg bg-gray-800/50 hover:bg-gray-700/50 transition-colors flex items-center gap-1.5"
            title="لوحة الإدارة"
          >
          ...
          <button
            onClick={(): void => { logoutUser(); void navigate('/'); }}
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div>
                  ...
                  <input type="number" min={1} max={10} id="custom-qubits"
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
          <div className="flex flex-wrap items-center gap-6">
            <div>
              ...
              <div className="flex items-center gap-2">
                <input type="range" min={0} max={20} id="noise-level"
            ...
            <div>
              ...
              <select id="num-shots" value={numShots} onChange={e => setNumShots(Number(e.target.value))} className="p-2 bg-gray-700 rounded border border-gray-600 text-sm">
          ...
          {[
            ...
            <div key={i} className="flex items-center justify-between p-3 bg-gray-700/20 rounded-lg">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" defaultChecked={setting.checked} className="sr-only peer" aria-label={setting.label} />

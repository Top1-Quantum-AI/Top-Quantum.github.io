    ...
    <div className='min-h-screen relative overflow-hidden flex items-center justify-center p-6'>
      ...
      <div className='relative z-10 w-full max-w-lg'>
        ...
        <div className='relative bg-black/80 backdrop-blur-2xl rounded-3xl p-10 border border-gray-700/50 shadow-2xl overflow-hidden'>
          ...
          <div
            className='absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent animate-pulse'
            style={{ animationDelay: '1s' }}
          />
          <div
            className='absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-transparent via-pink-400 to-transparent animate-pulse'
            style={{ animationDelay: '2s' }}
          />
          <div
            className='absolute right-0 top-0 w-1 h-full bg-gradient-to-b from-transparent via-yellow-400 to-transparent animate-pulse'
          ...
          <div className='text-center mb-10'>
            ...
            <div className='relative mb-6'>
              ...
              <div
                className='absolute inset-0 text-8xl animate-pulse opacity-50'
                style={{ animationDelay: '1s' }}
              >
                🌌
              </div>
            ...
            <div className='text-sm text-gray-500 font-mono'>🔐 نظام الدخول الآمن المتقدم</div>
          </div>
          ...
          <div className='space-y-8'>
            ...
            <div className='text-center space-y-3'>
              <div className='text-xs text-gray-500 font-mono'>🔬 نظام الأمان الكمي المتقدم</div>
      ...
      {/* تأثيرات إضافية */}
      <div
        className='absolute bottom-10 left-10 text-6xl animate-bounce opacity-30'
        style={{ animationDuration: '3s' }}
      >
        🌟
      </div>
      <div
        className='absolute top-10 right-10 text-4xl animate-spin opacity-20'
      ...
      <div
        className='absolute bottom-1/3 right-20 text-5xl animate-bounce opacity-20'

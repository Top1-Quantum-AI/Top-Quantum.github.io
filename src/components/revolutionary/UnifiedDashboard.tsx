    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="quantum-card hologram bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-3">
              <button
                onClick={() => { void startSimulation('quantum_neural_network'); }}
              ...
              <button
                onClick={() => { void startSimulation('quantum_reinforcement_learning'); }}
                disabled={processingStates.isRunningQuantum}
              ...
              <button
                onClick={() => { void startSimulation('quantum_optimization'); }}
                disabled={processingStates.isRunningQuantum}
        ...
        <div className="quantum-card hologram bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          ...
          <div className="space-y-4">
            <button
              onClick={() => { void startAgentLearning(); }}

            ...
            <>
                ...
                {keys.length === 0 ? (
                  ...
                  keys.map(apiKey => (
                    ...
                    >
                      <div className='flex items-center justify-between mb-3'>
                        <div className='flex items-center gap-2'>
                          ...
                          {apiKey.status === 'active' ? (
                            ...
                            <span className='px-1.5 py-0.5 bg-red-500/10 text-red-400 text-[10px] rounded-full font-medium'>
                              ملغى
                            </span>
                          )}
                        </div>
                      ...
                      <div
                        className='font-mono text-xs bg-gray-900/50 rounded-lg px-3 py-2 text-gray-400 mb-3'
                        dir='ltr'
                      >
                      ...
                      <div className='flex items-center gap-4 text-[11px] text-gray-500'>
                        ...
                        <span>{apiKey.requests.toLocaleString()} طلب</span>
                        {apiKey.lastUsed && (
                          <span>
              ...
              <div className='bg-gray-800/50 border border-gray-700/50 rounded-xl p-4'>
                ...
                <div className='space-y-2 text-xs text-gray-400'>
                  ...
                  <code
                    className='block bg-gray-900 rounded-lg px-3 py-2 text-green-400 font-mono'
                    dir='ltr'
                  >
                  ...
                  <code
                    className='block bg-gray-900 rounded-lg px-3 py-2 text-blue-400 font-mono'
                    dir='ltr'
                  >

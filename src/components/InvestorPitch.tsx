    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      {[
        ...
        },
        {
          ...
          desc: 'نماذج GPT مدمجة مع دوائر كمية لتسريع التعلم الآلي بمعامل 10x-100x مقارنة بالحوسبة الكلاسيكية',
...
const RoadmapSlide: React.FC = () => {
  const phases = [
    ...
    },
    {
      ...
      items: ['وحدة الأمان الكمي PQC', 'دمج GPT-4 مع الدوائر الكمية', 'جولة Seed $3M'],

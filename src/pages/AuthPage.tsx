...
import { apiRegister, apiLogin, checkBackendAvailable, type ApiError } from '../services/apiClient';
import {
  createUser,
  loginUser,
  getCurrentUser,
...
const AuthPage: React.FC = () => {
  ...
  const initialPlan: PlanId =
    planParam != null && validPlans.includes(planParam as PlanId) ? (planParam as PlanId) : 'free';
          ...
          <div className='space-y-4'>
            {[
              ...
              },
              {
                ...
                text: 'أمان ما بعد الكم من الدرجة العسكرية',
              },
            ].map((item, i) => (
